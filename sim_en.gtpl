...
<link rel="shortcut icon" type="image/png" href="http://foxylab.com:7777/static/favicon.pngg" />
...
<td><b><i><strong style="font-size: 12px;">FoxySim - online circuit simulator</strong></i></b></td><td align="right"><a href="ru"><img src="static/ru.png" alt="" /></a>&nbsp;<a href="en"><img src="static/en.png" alt="" /></a></td>
</tr>
</table>
<table style="width:300px; margin: 0px;" cellspacing="0">
<tr>
<td align="left"><font color="blue">Netlist:</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<td align="right" valign="middle"><form  action="/reset" method="post" style="display: inline-block; margin: 0;"><input type="submit" value="Clear"></form></td>
</tr>
</table>
<form action="/calc" method="post">
<textarea style="width:300px;" rows="16" name="netlist" id="netlist" value="" class="textfield" value="" spellcheck="false">{{.Net}}</textarea>
<br/><input type="submit" value="Go!">
<input type="hidden" name="security" id="security" value="{{.Sec}}">
</form>
</p>
<p class="small">
Your IP:&nbsp;<font color="blue">{{.Ip}}</font><br/> 
<table style="width:300px; margin: 0px; margin-top: -5px;">
<tr>
<td class="small">
<a href="https://t.me/foxysim"><img src="static/telegram.png" alt="" /></a><br/>
